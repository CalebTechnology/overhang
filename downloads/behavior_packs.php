...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Behavior Packs - Overhang</title>
  ...
  <body>
    ...
    <main>
      ...
      <div class="container">
        <div class="row">
          <div class="col">
            <h1>All Behavior Packs:</h1>
          </div>
        </div>
        <div class="row">
          <div class="col">
            <?php
               include '../includes/behavior_connect.php';
               ...
               foreach ($conn->query($sql) as $row) {
                 ...
                 echo"<a class='btn btn-primary btn-lg' href='behavior_pack/" . $row['mcaddon'] . "' role='button' download>Download Mcaddon</a>" . PHP_EOL;
                 echo"<a class='btn btn-primary btn-lg' href='behavior_pack/" . $row['mcpack_b'] . "' role='button' download>Download Behavior Only</a>" . PHP_EOL;
                 echo"<a class='btn btn-primary btn-lg' href='behavior_pack/" . $row['mcpack_r'] . "' role='button' download>Download Resources Only</a>" . PHP_EOL;
                 echo "<hr></div>" . PHP_EOL;
               }
            ?>
          </div>
