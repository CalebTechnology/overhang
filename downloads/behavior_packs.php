          ...
          <div class="col">
            <?php
               ...
               foreach ($conn->query($sql) as $row) {
                 ...
                 echo"<a class='btn btn-primary btn-lg' href='behavior_pack/" . $row['mcaddon'] . "' role='button'>Download Mcaddon</a>" . PHP_EOL;
                 echo"<a class='btn btn-primary btn-lg' href='behavior_pack/" . $row['mcpack_b'] . "' role='button'>Download Behavior Only</a>" . PHP_EOL;
                 echo"<a class='btn btn-primary btn-lg' href='behavior_pack/" . $row['mcpack_r'] . "' role='button'>Download Resources Only</a>" . PHP_EOL;
                 echo "<hr></div>" . PHP_EOL;
               }
            ?>
          </div>
