    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdown01">
          ...
          ?>
          <hr>
          <a class='dropdown-item' href="../activities/lumbo_land.php"><span class="far fa-compass"></span> Season 2 Quest</a>
        </div>
      </li>
      <li class="nav-item dropdown">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown01">
          ...
          <?php
            ...
            <div class="container">
              <a class="dropdown-item" href="../dashboard/settings/change_email.php"><span class="fas fa-at"></span> Change Email</a>
              <a class="dropdown-item" href="../dashboard/settings/change_phone.php"><span class="fas fa-phone-alt"></span> Change Phone Number</a>
            </div>
          <?php
          }
          ?>
