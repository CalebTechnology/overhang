      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown01">
          ...
          <?php
            ...
            <div class="container">
              <a class="dropdown-item" href="../settings/change_email.php"><span class="fas fa-at"></span> Change Email</a>
              <a class="dropdown-item" href="../settings/change_phone.php"><span class="fas fa-phone-alt"></span> Change Phone Number</a>
            </div>
          <?php
          }
          ?>
